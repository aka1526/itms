                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="{{ route('reqerp.save')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="text" id="fa_user" class="form-control" name="fa_user"  value="{{ $fa->fa_user}}" required="">
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="req_title" name="req_title"  class="form-control" required=""  placeholder="หัวข้อ/เรื่อง">
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <label class="control-label col-md-3 col-sm-3 ">เหตุผลประกอบการพิจารณา <span class="required">*</span>
                                    </label>

                                        <textarea class="form-control" rows="5" id="req_desc" name="req_desc" placeholder="เหตุผลประกอบการพิจารณา" required=""></textarea>
