        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>CHECK LIST COMPUTER </h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li>
                                    <button type="button" class="btn btn-success btn-sm" onclick="location.href='{{route('ch.add')}}'">
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">วิธีการตรวจสอบ</th>
                                      <th class="column-title">มาตราฐาน</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "> {{ $row->ch_item }}</td>
                                        <td class=" "> {{ $row->ch_desc }}</td>

                                        <td class=" "> {{ $row->ch_method }}</td>
                                        <td class=" "> {{ $row->ch_std }}</td>
                                        ...
                                        <td class=" ">
                                            <div class="btn-group ">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('ch.edit', $row->ch_uuid)}}"><i class="fa fa-pencil-square"></i> แก้ไขข้อมูล</a>


                                                    <a class="dropdown-item text-danger btn-delete" href="" data-uuid="{{$row->ch_uuid}}"><i class="fa fa-trash"></i> <strong>ลบข้อมูล</strong></a>
