        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2 align="center">เพิ่มข้อมูล CHECK LIST COMPUTER </h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <!-- start form for validation -->
                            <form id="form-post" name="form-post" action="{{ route('ch.save')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               <input type="hidden" id="ch_uuid " class="form-control" name="ch_uuid "  >
                               <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <label for="ch_item">ลำดับ</label>
                                    <input type="number" id="ch_item" class="form-control" name="ch_item" min="1" max="30" value="{{ isset($item) ? $item : 1}}" required="" >
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <label for="ch_desc">รายการ</label>
                                    <input type="text" id="ch_desc" class="form-control" name="ch_desc"  required="" >
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <label for="ch_method">วิธีการตรวจสอบ</label>
                                    <input type="text" id="ch_method" class="form-control" name="ch_method"  required="" >
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <label for="ch_std">มาตราฐาน</label>
                                    <input type="text" id="ch_std" class="form-control" name="ch_std"  required="" >
                                </div>
