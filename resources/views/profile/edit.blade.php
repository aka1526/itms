                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="{{ route('profile.update')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name"  value="{{$dataset->name}}" required="" >
                                </div>


                                <div class="col-md-3">
                                    <label for="email">{{ __('E-mail') }}</label>
                                    <input type="email" id="email" class="form-control" name="email" value="{{ $dataset->email}}">
                                </div>
