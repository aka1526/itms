        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2 align="center">เปลี่ยนรหัสผ่านผุ้ใช้</h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <!-- start form for validation -->
                            <form id="form-post" name="form-post" action="{{ route('pwd.update')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="password" id="new_password_confirmation" class="form-control" name="new_password_confirmation"  value="" required="" >
                                </div>
