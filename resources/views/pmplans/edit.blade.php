        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2 align="center">แก้ไขแผนบำรุงรักษาคอมพิวเตอร์</h2>
                             <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <!-- start form for validation -->
                            <form id="form-post" name="form-post" action="{{ route('pmplans.update')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               <input type="hidden" id="pm_uuid" class="form-control" name="pm_uuid" value="{{ $dataset->pm_uuid}}" >
                               <div class="row">

                                <div class="col-md-3 col-sm-3">
                                    <label for="fa_name">ชื่อคอมพิวเตอร์/อุปกรณ์</label>
                                    <input type="text" id="periods_name" class="form-control" name="fa_name" value="{{ $dataset->fa_name}}" readonly >
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <label for="fa_user">ผู้ใช้งาน</label>
                                    <input type="text" id="periods_name" class="form-control" name="fa_user" value="{{ $dataset->fa_user}}" readonly >
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <label for="pm_date">วันที่เดิม</label>
                                    <input type="date" id="pm_date" class="form-control" name="pm_date" value="{{ $dataset->pm_date}}" readonly >
                                </div>

                                <div class="col-md-3 col-sm-3">
                                    <label for="pm_date_new">วันที่ใหม่</label>
                                    <input type="date" id="pm_date_new" class="form-control" name="pm_date_new" value="" required="" >
                                </div>
