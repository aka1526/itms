                        ...
                        <div class="x_content">
                            ...
                            @if(session()->get('msg'))
                              ...
                              <div class="col-md-12">
                                ...
                                <p>
                                    <form id="frmSearch" name="frmSearch" action="{{ route('masterlist.import')}}" method="POST" enctype="multipart/form-data" >
                                        @csrf

                                        <div class="custom-file mt-3 mb-3">
                                            <input type="file" class="custom-file-input" id="uploadfile" name="uploadfile">
                                            <label class="custom-file-label" for="uploadfile">file upload</label>
                                          </div>
