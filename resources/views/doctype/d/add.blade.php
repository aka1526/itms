                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        ...
                        <select class="form-control form-control-sm h-50" id="SEC_CODE" name="SEC_CODE" required>
                            ...
                            @foreach ($SECTION as $key => $row)
                                <option value="{{ $row->SEC_CODE}}">{{ $row->SEC_NAME}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm h-50" name="DAR_REFER_PARTNAME" id="DAR_REFER_PARTNAME" placeholder="Doc. Name / Part Name" required>
                          </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm h-50" name="DAR_REFER_PROCESSNAME" id="DAR_REFER_PROCESSNAME" placeholder="Process Name">
                          </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm h-50" name="DAR_REFER_PARTNO" id="DAR_REFER_PARTNO" placeholder="P/No">
                          </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm h-50" name="DAR_REFER_CUSTOMERID" id="DAR_REFER_CUSTOMERID" placeholder="Customer ID" required>
                          </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm  h-50" name="DAR_REFER_DOC" id="DAR_REFER_DOC" placeholder="Doc.NO." required>
                          </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control form-control-sm h-50" name="DAR_REFER_REVNO" id="DAR_REFER_REVNO" placeholder="Rev.0" required>
                          </div>
                    </div>
