                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control form-control-sm  h-50" name="DAR_REFER_DOC" id="DAR_REFER_DOC" value="{{ $datarow->DAR_REFER_DOC }}" placeholder="Doc.NO." required>
                          </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm h-50" name="DAR_REFER_REVNO" id="DAR_REFER_REVNO" value="{{ $datarow->DAR_REFER_REVNO }}"  placeholder="Rev.0" required>
                          </div>
                    </div>
