                  ...
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            @if(session()->get('msg'))
                              ...
                              <div class="col-md-12">
                                <p>
                                    <form id="frmSearch" name="frmSearch" action="{{route('c.search')}}" method="POST" >
                                        @csrf
                                        ...
                                        <td class=" ">
                                            <div class="btn-group ">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('c.edit',$row->UNID) }}"><i class="fa fa-pencil-square"></i> แก้ไขข้อมูล</a>
