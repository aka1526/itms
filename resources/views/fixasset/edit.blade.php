                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="{{ route('fa.update')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               <input type="hidden" id="fa_uuid" class="form-control" name="fa_uuid" value="{{ $dataset->fa_uuid}}" >
                               <div class="row">

                                <div class="col-md-3">
                                    <label for="com_name">Computer Name</label>
                                    <input type="text" id="fa_name" class="form-control" name="fa_name"  value="{{ $dataset->fa_name}}" required="" >
                                </div>
                                <div class="col-md-3">
                                    <label for="date_buy">วันที่ซื้อ</label>
                                    <input type="date" id="date_buy" class="form-control" name="date_buy" value="{{ $dataset->date_buy}}"  >
                                </div>
                                <div class="col-md-6">
                                    <label for="fa_vender">ผู้ขาย</label>
                                    <input type="text" id="fa_vender" class="form-control" name="fa_vender" value="{{ $dataset->fa_vender}}" >
                                </div>


                                <div class="col-md-3">
                                    <label for="fa_sec">Section</label>
                                    <input type="text" id="fa_sec" class="form-control" name="fa_sec" value="{{ $dataset->fa_sec}}"  >
                                </div>

                                <div class="col-md-3">
                                    <label for="fa_user">User</label>
                                    <input type="text" id="fa_user" class="form-control" name="fa_user" value="{{ $dataset->fa_user}}">
                                </div>

                                <div class="col-md-3">
                                    <label for="fa_email">E-mail</label>
                                    <input type="text" id="fa_email" class="form-control" name="fa_email" value="{{ $dataset->fa_email}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="fa_tel">Tel</label>
                                    <input type="text" id="fa_tel" class="form-control" name="fa_tel"  value="{{ $dataset->fa_tel}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="fa_type">Type</label>
                                    <select class="form-control" id="fa_type" name="fa_type"  class="form-control" required="">
                                        <option value="">Choose option</option>
                                        <option value="PC" {{ $dataset->fa_type=='PC' ? ' selected' : '' }}>PC</option>
                                        <option value="NOTEBOOK" {{ $dataset->fa_type=='NOTEBOOK' ? ' selected' : '' }}>Notebook</option>
                                        <option value="PRINTER" {{ $dataset->fa_type=='PRINTER' ? ' selected' : '' }}>Printer</option>
                                        <option value="NETWORK" {{ $dataset->fa_type=='NETWORK' ? ' selected' : '' }}>Network</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="fa_status" name="fa_status">

                                        <option value="Y" {{ $dataset->fa_status=='Y' ? ' selected' : '' }}>ปกติ</option>
                                        <option value="N" {{ $dataset->fa_status!='Y' ? ' selected' : '' }}>ชำรุด</option>
