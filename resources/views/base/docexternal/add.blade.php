                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/docexternal/save" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                ...
                                <input type="text" id="DOC_NAME" class="form-control" name="DOC_NAME" value="" placeholder="หัวข้อเอกสารภายนอก" required />
                            ...
                            <p>
                                <input type="radio" class="flat" name="DOC_OTHER" id="DOC_OTHER_Y" value="Y" required /> มี
                                <input type="radio" class="flat" name="DOC_OTHER" id="DOC_OTHER_N" value="N"  checked="" /> ไม่มี
                            </p>
