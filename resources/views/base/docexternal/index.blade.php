        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>รายการหัวข้อเอกสารภายนอก </h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li>
                                    <button type="button" class="btn btn-success btn-sm" onclick="location.href='/base/docexternal/add';">
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">หัวข้อเอกสารภายนอก</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" last">
                                            <a href="/base/docexternal/edit/{{$row->UNID}}" ><i class="fa fa-edit"></i> </i>แก้ไข</a> |
...
$(document).on("click", '.btn-delete', function(e) {
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.isConfirmed){
        ...
        var url = '/base/docexternal/delete';
        $.ajax({
                type: "POST",
                url: url,
...
$(document).ready(function(){
        $("input:checkbox").click(function() {
            var checked="N";
            var unid = $(this).data('unid');
            var url = '/base/docexternal/upstatus';
