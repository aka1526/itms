        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>เอกสารทบทวนที่เกี่ยวข้อง  </h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li>
                                    <button type="button" class="btn btn-success btn-sm" onclick="location.href='/base/review/add';">
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">รหัสเอกสาร</th>
                                      <th class="column-title">ชื่อเอกสาร </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "> {{ $row->REVIEW_INDEX }}</td>
                                        <td class=" "> {{ $row->REVIEW_CODE }}</td>
                                        <td class=" ">  {{ $row->REVIEW_NAME}}</td>
                                        <td class=" ">
                                        ...
                                        <td class=" last">
                                            <a href="/base/review/edit/{{$row->UNID}}" ><i class="fa fa-edit"></i> </i>แก้ไข</a> |
