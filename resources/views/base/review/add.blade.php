                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/review/save" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                <input type="hidden" id="UNID"  name="UNID" value="" />

                                <label for="REVIEW_CODE">รหัสเอกสาร :</label>
                                <input type="text" id="REVIEW_CODE" class="form-control" name="REVIEW_CODE" value="" placeholder="ประเภทเอกสาร" required />

                                <label for="REVIEW_NAME">ชื่อเอกสาร :</label>
                                <input type="text" id="REVIEW_NAME" class="form-control" name="REVIEW_NAME" value="" placeholder="หัวข้อวัตถุประสงค์" required />

                                <label for="REVIEW_INDEX">จัดลำดับ :</label>
                                <input type="number" id="REVIEW_INDEX" class="form-control" name="REVIEW_INDEX" min="0" value="1" placeholder="ลำดับ" required />


                                </br>
                                <label>ระบุอื่นๆ * :</label>
                                <p>
                                    <input type="radio" class="flat" name="REVIEW_OTHER" id="REVIEW_OTHER_Y" value="Y" /> มี
                                    <input type="radio" class="flat" name="REVIEW_OTHER" id="REVIEW_OTHER_N" value="N"    checked="" required/> ไม่มี
                                </p>
                                ...
                                <p>
                                    ...
                                    <input type="radio" class="flat" name="REVIEW_STATUS" id="REVIEW_STATUS_Y" value="Y" checked="" required /> เปิดใช้งาน
                                    <input type="radio" class="flat" name="REVIEW_STATUS" id="REVIEW_STATUS_N" value="N" /> ปิดใช้งาน
                                </p>
                                 <br />
