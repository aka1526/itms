                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/section/save" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                <input type="hidden" id="UNID"  name="UNID" value="" />

                            <div class="col-md-12 col-sm-12 ">
                                <label for="SEC_CODE">รหัสหน่วยงาน :</label>
                                <input type="text" id="SEC_CODE" class="form-control" name="SEC_CODE" value="" placeholder="รหัสหน่วยงาน" required />
                            </div>
                            <div class="col-md-12 col-sm-12 ">
                                <label for="SEC_NAME">ชื่อหน่วยงาน :</label>
                                <input type="text" id="SEC_NAME" class="form-control" name="SEC_NAME" value="" placeholder="ชื่อหน่วยงาน" required />
                            </div>
                            <div class="col-md-6 col-sm-6 ">
                                <label for="REQ_EMAIL">E-mail ผู้ร้องขอเอกสาร  :</label>
                                <input type="text" id="REQ_EMAIL" class="form-control" name="REQ_EMAIL" value="" placeholder="E-mail ผู้ร้องขอเอกสาร"  />
                            </div>
                                <div class="col-md-6 col-sm-6 ">
                                    <label for="APP_EMAIL">E-mail ผู้อนุมัติเอกสาร   :</label>
                                    <input type="text" id="APP_EMAIL" class="form-control" name="APP_EMAIL" value="" placeholder="E-mail ผู้อนุมัติเอกสาร"  />
                                </div>
                            <div class="col-md-12 col-sm-12 ">
                                </br>
                                <label>ระบุอื่นๆ * :</label>
                                <p>
                                    <input type="radio" class="flat" name="SEC_OTHER" id="SEC_OTHER_Y" value="Y" /> มี
                                    <input type="radio" class="flat" name="SEC_OTHER" id="SEC_OTHER_N" value="N"    checked="" required/> ไม่มี
                                </p>
                            </div>
                            <div class="col-md-12 col-sm-12 ">
                                </br>
                                ...
                                <p>
                                    ...
                                    <input type="radio" class="flat" name="SEC_STATUS" id="SEC_STATUS_Y" value="Y" checked="" required /> เปิดใช้งาน
                                    <input type="radio" class="flat" name="SEC_STATUS" id="SEC_STATUS_N" value="N" /> ปิดใช้งาน
                                </p>
                            </div>
