        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>รายชื่อหน่วยงาน </h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li>
                                    <button type="button" class="btn btn-success btn-sm" onclick="location.href='/base/section/add';">
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">รหัสหน่วยงาน </th>
                                      <th class="column-title">ชื่อหน่วยงาน </th>
                                      <th class="column-title">E-mail ผู้ร้องขอ </th>
                                      <th class="column-title">E-mail ผู้อนุมัติ </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "> {{ $row->SEC_INDEX }}</td>
                                        <td class=" "> {{ $row->SEC_CODE }}</td>
                                        <td class=" ">  {{ $row->SEC_NAME}}</td>
                                        <td class=" ">  {{ $row->REQ_EMAIL}}</td>
                                        <td class=" ">  {{ $row->APP_EMAIL}}</td>
                                        <td class=" ">
                                           @if( $row->SEC_STATUS=="Y" )
                                        ...
                                        <td class=" last">
                                            <a href="/base/section/edit/{{$row->UNID}}" ><i class="fa fa-edit"></i> </i>แก้ไข</a> |
