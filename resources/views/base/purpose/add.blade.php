                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/purpose/save" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                <input type="hidden" id="UNID"  name="UNID" value="" />

                                <label for="PURPOSE_CODE">ประเภทเอกสาร :</label>
                                <input type="text" id="PURPOSE_CODE" class="form-control" name="PURPOSE_CODE" value="" placeholder="ประเภทเอกสาร" required />
                                ...
                                <input type="text" id="PURPOSE_URL" class="form-control" name="PURPOSE_URL" value="" placeholder="Url"  />
