        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>รายการหัวข้อวัตถุประสงค์   </h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li> <button type="button" class="btn btn-success btn-sm" onclick="location.href='/base/purpose/add';">
                                    <i class="fa fa-plus"></i> เพิ่มข้อมูล</button></li>
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">หัวข้อวัตถุประสงค์ </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "> {{ $row->PURPOSE_CODE }}</td>
                                        <td class=" ">  {{ $row->PURPOSE_NAME}}</td>
                                        <td class=" ">
                                           @if( $row->PURPOSE_STATUS=="Y" )
                                        ...
                                        <td class=" last">
                                            <a href="/base/purpose/edit/{{$row->UNID}}" ><i class="fa fa-edit"></i> </i>แก้ไข</a> |
