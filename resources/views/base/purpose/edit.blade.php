                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/purpose/update" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                <input type="hidden" id="UNID"  name="UNID" value="{{ $datarow->UNID}}" />


                                <label for="PURPOSE_CODE">ประเภทเอกสาร :</label>
                                <input type="text" id="PURPOSE_CODE" class="form-control" name="PURPOSE_CODE" value="{{ $datarow->PURPOSE_CODE}}" placeholder="ประเภทเอกสาร" required />

                                <label for="PURPOSE_NAME">หัวข้อวัตถุประสงค์ :</label>
                                <input type="text" id="PURPOSE_NAME" class="form-control" name="PURPOSE_NAME" value="{{ $datarow->PURPOSE_NAME}}" placeholder="หัวข้อวัตถุประสงค์" required />

                                <label for="PURPOSE_URL">Url ใช้งาน:</label>
                                <input type="text" id="PURPOSE_URL" class="form-control" name="PURPOSE_URL" value="{{ $datarow->PURPOSE_URL}}" placeholder="Url"  />
                                ...
                                <p>
                                    ...
                                    <input type="radio" class="flat" name="PURPOSE_STATUS" id="PURPOSE_STATUS_Y" value="Y"  {{ $datarow->PURPOSE_STATUS =="Y" ? 'checked=""' : ''}}  required /> เปิดใช้งาน
                                    <input type="radio" class="flat" name="PURPOSE_STATUS" id="PURPOSE_STATUS_N" value="N" {{ $datarow->PURPOSE_STATUS =="N" ? 'checked=""' : ''}} /> ปิดใช้งาน
                                </p>
                                 <br />
