        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>รายชื่อประเภทเครื่องจักร </h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li>
                                    <button type="button" class="btn btn-success btn-sm" onclick="location.href='/base/mctype/add';">
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">รหัสประเภท</th>
                                      <th class="column-title">ประเภทเครื่องจักร </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "> {{ $row->MCTYPE_CODE }}</td>
                                        <td class=" ">  {{ $row->MCTYPE_NAME}}</td>
                                        <td class=" ">
                                           @if( $row->MCTYPE_STATUS=="Y" )
                                        ...
                                        <td class=" last">
                                            <a href="/base/mctype/edit/{{$row->UNID}}" ><i class="fa fa-edit"></i> </i>แก้ไข</a> |
