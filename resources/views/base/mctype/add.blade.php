                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/mctype/save" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                <input type="hidden" id="UNID"  name="UNID" value="" />

                                <label for="MCTYPE_CODE">รหัสประภทเครื่องจักร :</label>
                                <input type="text" id="MCTYPE_CODE" class="form-control" name="MCTYPE_CODE" value="" placeholder="รหัสประภทเครื่องจักร" required />

                                <label for="MCTYPE_NAME">ชื่อประภทเครื่องจักร :</label>
                                <input type="text" id="MCTYPE_NAME" class="form-control" name="MCTYPE_NAME" value="" placeholder="ชื่อประภทเครื่องจักร" required />
                                ...
                                <p>
                                    ...
                                    <input type="radio" class="flat" name="MCTYPE_STATUS" id="MCTYPE_STATUS_Y" value="Y" checked="" required /> เปิดใช้งาน
                                    <input type="radio" class="flat" name="MCTYPE_STATUS" id="MCTYPE_STATUS_N" value="N" /> ปิดใช้งาน
                                </p>
                                 <br />
