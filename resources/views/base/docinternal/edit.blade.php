                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/docinternal/update" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                ...
                                <input type="text" id="DOC_NAME" class="form-control" name="DOC_NAME" value="{{ $datarow->DOC_NAME}}" placeholder="หัวข้อเอกสารภายใน" required />
