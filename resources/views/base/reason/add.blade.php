                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/base/reason/save" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                <input type="hidden" id="UNID"  name="UNID" value="" />
{{--
                                <label for="REASON_CODE">ประเภทเอกสาร :</label>
                                <input type="text" id="REASON_CODE" class="form-control" name="REASON_CODE" value="" placeholder="ประเภทเอกสาร" required /> --}}

                                <label for="REASON_NAME">หัวข้อวัตถุประสงค์ :</label>
                                <input type="text" id="REASON_NAME" class="form-control" name="REASON_NAME" value="" placeholder="หัวข้อวัตถุประสงค์" required />

                                <label for="REASON_INDEX">จัดลำดับ :</label>
                                <input type="number" id="REASON_INDEX" class="form-control" name="REASON_INDEX" min="0" value="1" placeholder="ลำดับ" required />

                                </br>
                                <label>ระบุอื่นๆ * :</label>
                                <p>
                                    <input type="radio" class="flat" name="REASON_OTHER" id="REASON_OTHER_Y" value="Y" /> มี
                                    <input type="radio" class="flat" name="DREASON_OTHER" id="REASON_OTHER_N" value="N"    checked="" required/> ไม่มี
                                </p>
                                ...
                                <p>
                                    ...
                                    <input type="radio" class="flat" name="REASON_STATUS" id="REASON_STATUS_Y" value="Y" checked="" required /> เปิดใช้งาน
                                    <input type="radio" class="flat" name="REASON_STATUS" id="REASON_STATUS_N" value="N" /> ปิดใช้งาน
                                </p>
                                 <br />
