        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>รายการหัวข้อเหตุผลในการขอ  </h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li>
                                    <button type="button" class="btn btn-success btn-sm" onclick="location.href='/base/reason/add';">
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">หัวข้อเหตุผลในการขอ </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "> {{ $row->REASON_CODE }}</td>
                                        <td class=" ">  {{ $row->REASON_NAME}}</td>
                                        <td class=" ">
                                           @if( $row->REASON_STATUS=="Y" )
                                        ...
                                        <td class=" last">
                                            <a href="/base/reason/edit/{{$row->UNID}}" ><i class="fa fa-edit"></i> </i>แก้ไข</a> |
