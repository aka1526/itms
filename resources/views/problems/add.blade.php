                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="{{ route('pb.save')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               <input type="hidden" id="problem_uuid" class="form-control" name="problem_uuid"  >
                               <div class="row">

                                <div class="col-md-3">
                                    <label for="com_name">รหัสปัญหา</label>
                                    <input type="text" id="problem_code" class="form-control" name="problem_code"  required="" >
                                </div>
                                <div class="col-md-9">
                                    <label for="problem_name">ชื่อปัญหา</label>
                                    <input type="text" id="problem_name" class="form-control" name="problem_name"  required="" >
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="group" name="group"  class="form-control" required="">
                                        ...
                                        <option value="COMPUTER" >Computer/Noterbook</option>
