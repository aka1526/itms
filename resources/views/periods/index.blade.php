        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>ข้อมูลรอบระยะเวลา</h2>
                            <ul class="nav navbar-right panel_toolbox">
								<li>
                                    <button type="button" class="btn btn-success btn-sm" onclick="location.href='{{route('pe.add')}}'">
                        ...
                        <div class="x_content">
                            ...
                            @if(session()->get('msg'))
                              ...
                              <div class="col-md-12">
                                ...
                                <p>
                                    <form id="frmSearch" name="frmSearch" action="{{ route('pe.index')}}" method="POST" >
                                        @csrf
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">ชื่อรอบ</th>
                                      <th class="column-title">ระยะเวลา(เดือน)</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "> {{ $row->periods_name }}</td>
                                        <td class=" "> {{ $row->periods_interval }}</td>
                                        ...
                                        <td class=" ">
                                            <div class="btn-group ">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('pe.edit', $row->periods_uuid)}}"><i class="fa fa-pencil-square"></i> แก้ไขข้อมูล</a>


                                                    <a class="dropdown-item text-danger btn-delete" href="" data-uuid="{{$row->periods_uuid}}"><i class="fa fa-trash"></i> <strong>ลบข้อมูล</strong></a>
