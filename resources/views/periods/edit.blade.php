                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="{{ route('pe.update')}}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                               <input type="hidden" id="periods_uuid" class="form-control" name="periods_uuid" value="{{ $dataset->periods_uuid}}" >
                               <div class="row">

                                <div class="col-md-9 col-sm-6">
                                    <label for="com_name">ชื่อรอบเวลา</label>
                                    <input type="text" id="periods_name" class="form-control" name="periods_name" value="{{ $dataset->periods_name}}" required="" >
                                </div>
                                <div class="col-md-3 col-sm-6">
                                    <label for="periods_interval">ระยะเวลา (เดือน)</label>
                                    <input type="number" id="periods_interval" class="form-control" name="periods_interval" min="0" max="20" value="{{ $dataset->periods_interval}}"  required="" >
                                </div>

                               </div>
                                <br />
                                <a href="/periods"   class="btn btn-secondary"> <i class="fa fa-arrow-left"></i> กลับ </a>
